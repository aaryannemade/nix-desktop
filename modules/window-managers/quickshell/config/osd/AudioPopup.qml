...
PopupBase {
    ...
    component DeviceRow: Rectangle {
        ...
        MouseArea {
            ...
            onClicked:    devRow.selected(devRow.modelData.id)
        }
    }
    ...
    Column {
        ...
        Repeater {
            ...
            DeviceRow {
                isActive: modelData.id === AudioState.defaultSink
                onSelected: (id) => AudioState.setDefaultSink(id)
            }
        }
        ...
        Repeater {
            ...
            DeviceRow {
                isActive: modelData.id === AudioState.defaultSource
                onSelected: (id) => AudioState.setDefaultSource(id)
            }
        }
