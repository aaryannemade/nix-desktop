...

{
  wayland.windowManager.mango = {
    ...
    autostart_sh = ''
      ...
      systemctl --user restart opendeck.service
    ...
    settings = {
      ...
      # source-optional: the file is generated at runtime by noctalia, so it
      # doesn't exist when home-manager validates the config at build time.
